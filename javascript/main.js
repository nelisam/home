...
let products = [ 
    {
        name: 'Become a Front End Web Developer in 4 Weeks',
        tag: 'frontend-dev', //use to grab the image
        price: 9000,
        inCart: 0 //track how many items
    },
    {
        name: 'Become a Full Stack Web Developer in 12 Weeks',
...
function displayCart() {
    ...
    if( cartItems && productContainer ) {
        ...
        Object.values(cartItems).map( (item, index) => {
            productContainer.innerHTML += 
            `<div class="product"><ion-icon name="close-outline"></ion-icon><img src="./images/${item.tag}.png" />
        ...
        productContainer.innerHTML += `
            <div class="cartTotalContainer">
                ...
                <h6 class="cartTotal">Sub Total</h6>
                <h6 class="cartTotal">R${cart},00</h6>
                <h6 class="cartTotal">Vat 15%</h6>
                <h6 class="cartTotal"></h6>
                <h6 class="cartTotal">Total</h6>
                <h6 class="cartTotal"></h6>
            </div>`
